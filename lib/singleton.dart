...
class Singleton {
  ...
  static Map<String, dynamic> settings = {
    ...
    "DefaultWalletId": "1",
    "AggregatePaymentFromMultipleWallets": "0", // It's not possible sometimes to make a transaction from multiple wallet like in ETH
    "LocalCurrency": "USD",
    "HideBalance": "false",
  };
  static bool DEBUG = true;
  static Currency currentCurrency = Currency("United State Dollar", "USD", "\$", true);
  ...
  static ThemeData getDarkTheme() {
    ...
    return ThemeData(
        ...
        elevatedButtonTheme: ElevatedButtonThemeData(style: ButtonStyle(
          backgroundColor: WidgetStateProperty.all<Color?>(Color.fromARGB(255, 28, 28, 28)),
          foregroundColor: WidgetStateProperty.all<Color?>(Color.fromARGB(255, 247, 247, 247)),
        )),
        appBarTheme: AppBarTheme(
        ...
        textTheme:
            textTheme.apply(bodyColor: Color.fromARGB(255, 255, 255, 255)),
        primaryTextTheme: textTheme.apply(bodyColor: Color(0xff4f4f4f)));
  }
  ...
  static void sendNotification(String title, String body, {String? payload}) async {
    if (!notificationsEnabled) {
      return;
    }
    const AndroidNotificationDetails androidNotificationDetails =
    AndroidNotificationDetails('tejory', 'Tejory',
