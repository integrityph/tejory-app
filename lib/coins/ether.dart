...
class Ether extends CryptoCoin {
  // constants
  ...
  BigInt getBaseAmount(double val) {
    return BigInt.from((val * 1000000000000000000).round());
  }

  @override
  String getDecimalAmount(BigInt val) {
    return (val.toDouble() / 1000000000000000000).toStringAsFixed(18);
  }
